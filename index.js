...
console.log(josh.stomach);
 ...
 function Car(model, milesPerGalllon) {
    this.model = model;
    this.milesPerGallon = milesPerGalllon;  
    this.tank = 0;
    this.odometer = 0;
  }
  ...
  Car.prototype.drive = function(distance) {
    let mpgConversion = distance/this.milesPerGalllon;
    this.odometer += distance;
    this.tank -= mpgConversion;

    if(this.tank === 0 || mpgConversion) {
